"""
Operations: the public processing vocabulary with physical parameters only.
...
Includes the composite filters :class:`IIRFilter` and :class:`FIRFilter`,
which orchestrate the kernel primitives, and the physical-parameter atoms
built on top of them: :class:`Filter`, :class:`Resample`, :class:`Integrate`,
:class:`Differentiate`, :class:`STFT`.

Each operation atom has a function form generated with
